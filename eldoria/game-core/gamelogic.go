...
func itemList() []itemsPool {
	i := []itemsPool{ 
		...
		{index: 5, name: "iron_plate", category: "armor", cost: 200, heal: 0,attack: 0,strength: 0, defense: 10, agility: -4, constitution: 0},
		{index: 6, name: "steel_plate", category: "armor", cost: 250, heal: 0,attack: 0,strength: 0, defense: 14, agility: -4, constitution: 0},
